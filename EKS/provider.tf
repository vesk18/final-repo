...
provider "kubernetes" {
  host                   = aws_eks_cluster.vesk18.endpoint
  cluster_ca_certificate = base64decode(aws_eks_cluster.vesk18.certificate_authority.0.data)
  token                  = data.aws_eks_cluster_auth.vesk18.token
}
